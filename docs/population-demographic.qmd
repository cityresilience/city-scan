...
<!-- chart examples -->
::: {layout-ncol=2}
![Population Growth — year-over-year change (Oxford Economics)](image/2026-06-philippines-manila/03-render-output/plots/oxford-pop-growth.png){#fig-pop-growth .lightbox}

![Population time series vs. benchmark cities (Oxford Economics)](image/2026-06-philippines-manila/03-render-output/plots/oxford-pop-line.png){#fig-pop-line .lightbox}
...
![Population growth (Worldpop Global 1, 2000-2020)](image/2026-06-philippines-manila/03-render-output/plots/worldpop-g1-growth.png){#fig-pop-line .lightbox}

![Population growth (Worldpop Global 2, 2015-2030)](image/2026-06-philippines-manila/03-render-output/plots/worldpop-g2-growth.png){#fig-pop-line .lightbox}
:::
...
::: {layout-ncol=2}
![Population density](image/2026-06-philippines-manila/03-render-output/maps/population.png){#fig-pop-growth .lightbox}

![Population density distribution](image/2026-06-philippines-manila/03-render-output/plots/worldpop-pop-density-distribution.png){#fig-pop-line .lightbox}
:::
...
::: {layout-ncol=2}
![Age structure over time — Oxford Economics](image/2026-06-philippines-manila/03-render-output/plots/oxford-age-structure-area.png){#fig-age-structure .lightbox}

![Age distribution vs. benchmark cities](image/2026-06-philippines-manila/03-render-output/plots/oxford-pop-distro.png){#fig-pop-distro .lightbox}
:::
...
::: {layout-ncol=2}
![RWI — standardized (nationally comparable)](image/2026-06-philippines-manila/03-render-output/maps/rwi_standardized.png){#fig-rwi-std .lightbox}

![RWI — relative (city-internal)](image/2026-06-philippines-manila/03-render-output/maps/rwi_relative.png){#fig-rwi-rel .lightbox}
:::

::: {layout-ncol=2}
![RWI distribution — standardized](image/2026-06-philippines-manila/03-render-output/plots/rwi-histogram-standardized.png){#fig-rwi-hist-std .lightbox}

![RWI distribution — relative](image/2026-06-philippines-manila/03-render-output/plots/rwi-histogram-relative.png){#fig-rwi-hist-rel .lightbox}
:::
