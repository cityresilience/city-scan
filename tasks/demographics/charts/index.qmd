...
```{r}
#| label: setup-demographics
#| message: false
#| warning: false
#| results: hide
if (file.exists("_quarto.yml")) here::i_am("tasks/demographics/charts/index.qmd")
if (!exists("aoi")) source(here::here("core/R/setup.R"))
```

```{r}
#| label: data-loading-demographics
#| message: false
#| warning: false
#| results: hide
...
if (has_age_data) {
  ...
  print_text(paste("Under 5 years old:", under5$Percentage %>% {scales::label_percent()(.)}))
