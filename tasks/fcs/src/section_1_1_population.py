"""Country-level population processing functions for city-to-country ratio calculations."""
import os
...
def population_ratio(raster1_path, raster2_path):
    """
    Calculate the ratio of the total values of two rasters.
...
def process_rasters_by_prefix_suffix(folder_path, output_csv_path):
    """
    Process rasters with specific prefixes and a common wildcard suffix, compute ratios, 
    and export results to a CSV.
