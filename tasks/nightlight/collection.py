...
def datacollection(
    ...
    linfit_rio = fns.tiled_collection(linear_fit.select('scale'), aoi, scale=463.83, output_dir=output_dir)
    ...
    sum_rio = fns.tiled_collection(sum_of_light.select('avg_rad_sum'), aoi, scale=463.83, output_dir=output_dir)
